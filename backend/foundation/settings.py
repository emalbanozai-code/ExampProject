...
# Only apply SSL options for PostgreSQL connections.
if "postgres" in db_config.get("ENGINE", ""):
    if env_bool("DJANGO_DB_SSL_REQUIRE", not DEBUG):
...
print("REDIRECT: ", env_bool("DJANGO_SECURE_SSL_REDIRECT", not DEBUG))
